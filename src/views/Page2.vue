<template>
  <div class="page2">
    <div class="container">
      <div class="section1 theme1">
        <div class="content-wrapper">
          <div class="title">
            <span class="subtitle">黑心醫院 醫材違規重複用10次</span>
          </div>
        ...
        <div class="image-wrapper">
          <img src="../../public/images/article-images/index_page2_article_img1.jpg" alt="">
          <div class="discribe">
      ...
      <div class="theme-default">
        ...
        <div class="content">
          <span class="mark">
              “台大醫院確實重複使用「雙極電外科器械」，像是超音波刀、腹腔鏡閉合器等，出發點是為了幫患者省錢，依照院內手術管理委員會所討論出來的消毒SOP規範，徹底消毒後，使用次數最高5次。”
          </span>
        </div>
        <br>
        台大醫院「雙極電外科器械」自費價格僅需近7,000元，對此，記者親訪台大醫院大腸直腸科主任梁金銅，他不諱言地表示，
      ...
      <div class="theme1">
        ...
        <div class="image-wrapper">
          <img src="../../public/images/article-images/index_page2_article_img2.jpg" alt="">
          <div class="discribe">
            雙極電外科器械是外科腹腔鏡手術中常用的一次性手術耗材，但許多醫院私下消毒重複使用。
          </div>
        </div>
    ...
    <div class="container">
      <div class="button-wrapper">
        ...
        <div class="next-button">
          病患恐感染血液疾病<i class="nav-arrow nav-arrow-right i-arrow4-right" @click="scrollXContral('right')"></i>
        </div>
      </div>
    </div>
  </div>
